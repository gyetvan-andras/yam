...
## Description
YAM is a browser based animation editor with vide background and key frame based animations, implemented in HTML5 and JavaScript. YAM is Yet (another) Animation Manager.
