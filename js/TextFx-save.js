...
Object.defineProperties(TextFx.prototype, {
    ...
    style: {
        ...
        set: function (style)
        {
            ...
            this._style.align = style.align || 'left';
...
var getTextMetrics = function(style, line) {
    ...
    //     result.ascent = offs.top - text.offset().top;
    //     block.css({ verticalAlign: 'bottom' });
    //     result.height = offs.top - text.offset().top;

    //     result.descent = result.height - result.ascent;
    //     result.width = text.outerWidth(true);//oofset().width;
    // } finally {
    //     div.remove();
    // }
...
TextFx.prototype.drawTexture = function ()
{
    ...
    for (var i = 0; i < lines.length; i++)
    {
        ...
        // console.log('Widht of "'+line+'" is '+lineWidth);
    ...
    this.canvas.width = Math.ceil(( width + this._style.xPadding * 2 ) * this.resolution);
    this.canvas.height = Math.ceil(( height + this._style.yPadding * 2 ) * this.resolution);
    ...
    for (i = 0; i < lines.length; i++)
    {
        ...
        if(style.cutOut) {
            ...
            if(style.dropShadow) {
                ...
                ctx.shadowOffsetY = yShadowOffset;// + 1024; 
